        ...
        <section id="About" className="element container mx-auto  md:h-full flex flex-col items-center justify-center w-full m-1 md:max-w-4xl py-20 px-5 md:px-0 ">
             <div className="flex flex-col">
                <div className="text-base font-sans mb-10 flex items-center">
                    ...
                    <h2 className="mx-2 text-2xl md:text-3xl text-lightest-slate font-bold">About Me</h2> 
                    <h3 className="mx-5 border border-lightest-navy w-[30%] md:w-[40%]"> </h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-6 md:gap-4 ">
                    <div className="col-span-4">
                        <p className="  font-sans text-slate mb-2">Hi there, I&apos;m Ashwin, a frontend developer in building user-friendly and visually appealing websites. With a passion for web development, I am always looking to stay up-to-date with the latest technologies and trends in the industry. </p>
                        ...
                        <p className="  font-sans text-slate mb-2">When I&apos;m not coding, you can find me swimming, hiking, playing video games or travelling to beautiful destinations. </p>

                        <p className=" font-sans text-slate mb-2">I&apos;m always looking for opportunities to work with those who are willing to share their knowledge as much as I want to learn. At the end of the day, my primary goal is to create something beautiful with people that bring out the best in me.</p>
                        <p className=" font-sans text-slate">Here are a few technologies I&apos;ve been working with recently:</p>
                        <ul className="list-inside list-inline list-disc list-green grid grid-cols-2 font-mono text-sm mt-5 ">
                            ...
                            <li className="text-green"><span className='text-light-slate'>JavaScript <span className='hidden md:inline'>(ES6+)</span></span></li>
