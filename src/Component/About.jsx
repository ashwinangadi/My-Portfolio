             ...
             <div className="flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 md:gap-4 ">
                    <div className="col-span-4 me-5">
                        <p className="  font-sans text-slate mb-2 text-justify">Hi there, I&apos;m Ashwin, a frontend web developer in building user-friendly and visually appealing websites. With a passion for web development, I am always looking to stay up-to-date with the latest technologies and trends in the industry. </p>
                        <p className="  font-sans text-slate mb-2 text-justify">My expertise lies in HTML, CSS, JavaScript, React, and other front-end development tools. I take a user-centered approach to web design, ensuring that every website I create is optimized for usability and accessibility. I have a strong eye for design and enjoy working collaboratively with designers and other developers to create beautiful and functional websites. </p>
                        ...
                        <p className=" font-sans text-slate text-justify">Here are a few technologies I&apos;ve been working with recently:</p>
                        <ul className="list-inside list-inline list-disc list-green grid grid-cols-2 font-mono text-sm mt-5 ">

                            <li className="text-green"><span className='text-light-slate'>React.js</span></li>
                            ...
                            <li className="text-green"><span className='text-light-slate'>Typescript</span></li>
