            ...
            <div className="col-span-4 me-5">
              ...
              <ul className="list-inside list-inline list-disc list-green grid grid-cols-2 font-mono text-sm mt-5 ">
                <li className="text-green">
                  <span className="text-light-slate">React</span>
                </li>
                <li className="text-green">
                  <span className="text-light-slate">
                    Javascript <span className="hidden md:inline">(ES6+)</span>
                  </span>
                </li>
                <li className="text-green">
                  <span className="text-light-slate">TailWindCSS</span>
                </li>
                <li className="text-green">
                  <span className="text-light-slate">Bootstrap</span>
                </li>
                <li className="text-green">
                  <span className="text-light-slate">HTML</span>
                </li>
                <li className="text-green">
                  <span className="text-light-slate">CSS</span>
                </li>
                <li className="text-green">
                  <span className="text-light-slate">Typescript</span>
                </li>
                <li className="text-green">
                  <span className="text-light-slate">Redux</span>
                </li>
              </ul>
            </div>
